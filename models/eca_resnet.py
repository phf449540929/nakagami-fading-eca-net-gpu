...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=6, k_size=[3, 3, 3, 3]):
        ...
        # self.conv1 = nn.Conv2d(10, 64, kernel_size=4, stride=2, padding=3, bias=False)
        '''
        64
        '''
        ...
        # self.layer5 = self._make_layer(block, 1024, layers[4], int(k_size[4]), stride=2)
...
def eca_resnet18(k_size=[3, 3, 3, 3], num_classes=6, pretrained=False):
...
def eca_resnet34(k_size=[3, 3, 3, 3], num_classes=6, pretrained=False):
...
def eca_resnet50(k_size=[3, 3, 3, 3], num_classes=6, pretrained=False):
...
def eca_resnet101(k_size=[3, 3, 3, 3], num_classes=6, pretrained=False):
...
def eca_resnet152(k_size=[3, 3, 3, 3], num_classes=6, pretrained=False):
