...
def main():
    ...
    snr = root_dir.split('/')[-1] + '-exp'
    train_dir = root_dir + '-pre-adv-train.csv'
    validate_dir = root_dir + '-pre-adv-validate.csv'
    # train_dir = root_dir + '-train.csv'
    # validate_dir = root_dir + '-validate.csv'
    print(root_dir)
    ...
    # acc_plot_tra = {}
    # acc_txt_tra = "/acc-tra-{}.txt".format(datetime.datetime.now().strftime('%Y-%m-%d %H-%M-%S.%f'))

    acc_plot_val = {}
    acc_txt_val = "/acc-val-{}.txt".format(datetime.datetime.now().strftime('%Y-%m-%d %H-%M-%S.%f'))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # prec1, prec5, acc_str_tra = validate(train_loader, model, criterion, trans_list)
        prec1, prec5, acc_str_val = validate(val_loader, model, criterion, trans_list)
        ...
        # acc_plot_tra[epoch] = acc_str_tra
        acc_plot_val[epoch] = acc_str_val
        ...
        # data_save(fold + acc_txt_tra, acc_plot_tra)
        data_save(fold + acc_txt_val, acc_plot_val)
